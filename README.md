# Boas vindas ao repositório do Movie Card Library Crud!
Nesse projeto fiz o meu primeiro CRUD (Create, Read, Update and Delete) e melhorei meus conhecimentos sobre props e state em React. 

Ele teve como objetivo, criar um **CRUD** de cartões de filmes em React, no qual eu pudesse adionar novos filmes, deletar e modificar informações dos já existentes.
Esse projeto me deu um pouco de nostalgia, me lembro do dia que ele ficou pronto. 

Achei bem bonitos aqueles cards no estilo Netflix. Também gostei de ficar brincado de deletar e adicionar novos filmes.
...
```bash
git clone https://github.com/AndreBarroso/sd-010-a-project-movie-card-library-crud.git
```
4. Acesse a pasta criada executando o comando a seguir:
```bash
cd sd-010-a-project-movie-card-library-crud.git
```
